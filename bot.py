...
# ===== ТВОИ ТОКЕНЫ =====
TOKEN = "8587097239:AAF8DaRGJwekH_NBxnOCg-any5wXwYN1drA"          # от @BotFather
HF_TOKEN = "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"    # с huggingface.co/settings/tokens
# ========================
...
try:
    ...
    print("HF response:", resp.text[:300])
